...
VTraceFromLogProbsReturns = collections.namedtuple(
    "VTraceFromLogProbsReturns",
    [
        "vs",
        "pg_advantages",
        "log_rhos",
...
def from_log_probs(
    ...
    target_action_log_probs = action_log_probs(
        torch.flatten(target_policy_log_probs, 0, 1),
        actions
    )
    behavior_action_log_probs = action_log_probs(
        torch.flatten(behavior_policy_log_probs, 0, 1),
        actions
    )
    ...
    return VTraceFromLogProbsReturns(
        log_rhos=log_rhos,
