...
# sys.path.append('/home/isaiah/GitHub/Kaggle/Hungry_Geese/')
        ...
        try:
            ...
            try:
                self.model.load_state_dict(torch.load(
                    Path.home() / 'GitHub/Kaggle/Hungry_Geese/strong_agents/v032_supervised_pretraining_min1025_89.0/cp.pt'
                ))
            except FileNotFoundError:
                self.model.load_state_dict(torch.load(
                    Path.home() / 'github_misc/Kaggle_Hungry_Geese/strong_agents/v032_supervised_pretraining_min1025_89.0/cp.pt'
                ))
        self.model.eval()
